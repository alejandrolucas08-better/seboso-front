...
```
src/
├── components/      # UI reutilizável (cards, forms, modais, skeleton)
├── layouts/         # PublicLayout, DashboardLayout, Sidebar variants
├── pages/           # Rotas públicas e privadas
├── services/        # api.ts, endpoints tipados, interceptors
├── context/         # AuthContext, ThemeContext
├── hooks/           # useAuth, useFetch, useFilters
