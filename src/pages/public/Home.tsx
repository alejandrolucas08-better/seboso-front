...
import { getStores } from "../../services/store.service"; // Importa a função getStores do serviço de API para buscar a lista de sebos
...
export default function Home() {
  ...
  return (
    <>
      <h1 className="text-2xl font-semibold mb-6">Sebos e Livreiros</h1>
