        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#C37351]"
              value={formData.name}
          ...
          <button
            type="submit"
            className="bg-[#C37351] hover:bg-[#A85F42] text-white py-2 rounded-lg transition-colors cursor-pointer font-medium mt-2"
            disabled={loading}
          >
